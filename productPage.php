                    ...
                    <div class="product product-details clearfix">
                        ...
                        <div class="col-md-6">
                            <div class="product-body">
                                ...
                                <h3 class="product-price">$<?php echo $product["preco"]?></h3> <div>
                            ...
                            <div class="product-btns">
                                <div class="qty-input">
                                    ...
                                    <input class="input" type="number" value="1" id="qty-input-prod-detail">
                                </div>
                                <button class="primary-btn add-to-cart" data-has-input="qty-input-prod-detail"
                                    data-product="<?php echo $product["id"]?>"></i> Add to
                                    Cart</button>
                                            ...
                                            <div class="product-reviews">
                                                <div class="single-review">
                                                    <div class="review-heading">
                                                        ...
                                                        <div><a href="#"><i class="fa fa-clock-o"></i> 27 DEC 2017 /
                                                                8:0 PM</a></div>
